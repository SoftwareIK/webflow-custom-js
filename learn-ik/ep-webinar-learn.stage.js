    ...
    $(".bc__btn-select-webinar-slot-v2").click((function (t) {
      ...
      if (e.preventDefault(), $("input:radio[name='start-date']").is(":checked")) {
        ...
        if (window.location.href == newUrl) {
          ...
          e = "NoPhoneInTheFirstStep" == $(".bye-calendly-type").val() ? "https://" + window.location.hostname + "/signup-final-step-v6" + r : "https://ikdev.webflow.io/signup-final-step" + "?utm_source=" + $(".utm_source").val() + "&utm_medium=" + n + "&salesforce_uuid=" + i,
