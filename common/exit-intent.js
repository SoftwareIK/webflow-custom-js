...
function initExitIntentPopup(eagerLoadImage, options = {}) {
            ...
            try {
              ...
              Object.keys(utmParams).forEach((key) => {
                if (utmParams[key]) {
                  ...
                  if(isNonLearnSite && key === "utm_source" && utmParams[key] === "Organic") {
  ...
  const shouldShowPopup = () => {
    ...
    try {
      isFormOpened =
        !!document.querySelector(".webinar__lightbox") &&
        getComputedStyle(document.querySelector(".webinar__lightbox"))
          .display != "none";
      isVideoOpened =
        !!document.querySelector(".w-lightbox-backdrop") &&
        getComputedStyle(document.querySelector(".w-lightbox-backdrop"))
          .display != "none";
    } catch (error) {
